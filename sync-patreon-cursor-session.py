#!/usr/bin/env python3
"""Patreon-Session aus einem Systembrowser in den Cursor-Browser übernehmen (Linux)."""
...
def parse_args(argv: list[str]) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Patreon-Session aus einem Systembrowser in den Cursor-Browser übernehmen.",
    )
    parser.add_argument(
        "--from",
        dest="browser",
